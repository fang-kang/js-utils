import { createElement } from 'src/browser';
import { isBlob, isFile, isString } from 'src/is';
...
export async function toBase64(o: File | string | Blob): Promise<Blob | string> {
  if (isFile(o) || isBlob(o)) return await fileToBase64(o as File | Blob);
  else if (isString(o)) return await urlToBase64(o as string);
